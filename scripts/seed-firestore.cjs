...
const duas = [
  ...
  },
  {
    ...
    difficulty: "intermediate",
    estDurationSec: 25,
    rizqBenefit: "The master supplication for forgiveness - said with conviction, it guarantees Paradise",
    propheticContext: "The Prophet (ﷺ) said: Whoever says this during the day with firm faith and dies the same day, will be among the people of Paradise",
    xpValue: 30
  },
  {
    id: 9,
