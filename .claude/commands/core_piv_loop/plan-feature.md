...
- Identify test framework and structure (Playwright for web, XCTest for iOS)
- Find similar test examples for reference
- Understand test organization (unit vs integration vs snapshot)
...
- `path/to/new_service.ts` - Service implementation for X functionality
- `path/to/new_model.ts` - Data model for Y resource
- `tests/path/to/test_new_service.ts` - Unit tests for new service
